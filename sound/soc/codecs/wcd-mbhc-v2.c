...
#if defined(CONFIG_KERNEL_CUSTOM_WHYRED)|| defined(CONFIG_KERNEL_CUSTOM_JASMINE) || defined(CONFIG_KERNEL_CUSTOM_WAYNE) || defined(CONFIG_KERNEL_CUSTOM_TULIP)
...
#if defined(CONFIG_KERNEL_CUSTOM_WHYRED) || defined(CONFIG_KERNEL_CUSTOM_WAYNE) || defined(CONFIG_KERNEL_CUSTOM_JASMINE) || defined(CONFIG_KERNEL_CUSTOM_TULIP)
			/*
